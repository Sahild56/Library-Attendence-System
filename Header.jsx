    ...
    return (
        <>
            <header style={{ background:'white',boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)'}}>
                ...
                <NavLink to="/" style={{background:'none',fontSize:'25px',fontFamily:'poppins',color:'rgba(113, 99, 186, 255)'}}><h1 ><span style={{position:'relative',top:'30px',left:'-30px',background:'rgba(113, 99, 186, 255)',color:'rgba(113, 99, 186, 255)'}}><IoBookSharp color=' rgba(113, 99, 186, 255)' /></span>Library Attendence System</h1></NavLink>
                    <div className="avtar">
                        {
